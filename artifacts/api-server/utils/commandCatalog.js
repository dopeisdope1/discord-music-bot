...
const CATEGORIES = [
  ...
  },
  {
    ...
    label: "Sécurité",
    emoji: EMOJI.LOCK,
    description: "Audit et listes du serveur",
    highlights: ["allbots", "security scan", "alladmins", "botadmins"],
    commands: [
      {
        name: "allbots",
        prefix: "mod",
      ...
      },
      {
        ...
        description: "Audit de sécurité (permissions dangereuses, @everyone, bots admin, logs, rôle de mute)",
      },
      {
        name: "alladmins",
        prefix: "mod",
