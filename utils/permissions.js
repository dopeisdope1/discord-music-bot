...
// utils/botOwners.js) — demande explicite : "y'a que moi qui a le droit".
const BOT_OWNER_ONLY_COMMANDS = ["say"];
 ...
 * interaction de commande slash (les deux exposent `.member`/`.guildId`,
 * et `.author`/`.user` pour l'ID de l'appelant).
