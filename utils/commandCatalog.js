...
const CATEGORIES = [
  {
    ...
    commands: [
      ...
      { name: "vc", prefix: "mod", permission: null, description: "Affiche le nombre de personnes actuellement en vocal" },
      { name: "stats", prefix: "mod", permission: null, description: "Affiche les statistiques du serveur (membres, en ligne, en vocal, en stream, actifs, mute)" },
      ...
      { name: "boosters", prefix: "mod", permission: null, description: "Affiche la liste des membres boostant le serveur" },
      { name: "rolemembers <rôle>", prefix: "mod", permission: null, description: "Affiche la liste des membres ayant un rôle précis (mention, ID ou nom)" },
      { name: "vocinfo", prefix: "mod", permission: null, description: "Affiche les informations relatives à l'activité vocale du serveur" },
      { name: "role <rôle> (infos)", prefix: "mod", permission: null, description: "Affiche les informations relatives à un rôle" },
      { name: "channel [salon] (infos)", prefix: "mod", permission: null, description: "Affiche les informations relatives à un salon" },
      { name: "user [membre]", prefix: "mod", permission: null, description: "Affiche les informations d'un compte Discord, même s'il n'est pas sur le serveur" },
      ...
      { name: "emoji <émoji>", prefix: "mod", permission: null, description: "Récupère l'image d'un émoji personnalisé (émoji, nom ou ID), y compris venu d'un autre serveur" },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: "unmuteall", prefix: "mod", permission: "moderation.timeout", description: "Lève le mute de tous les membres mute" },
      ...
      { name: "hideall", prefix: "mod", permission: "channels.manage", description: "Masque tous les salons gérables à @everyone" },
      { name: "unhideall", prefix: "mod", permission: "channels.manage", description: "Réaffiche tous les salons masqués" },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: "voicemove [salon] [salon]", prefix: "mod", permission: "server.voice.manage", description: "Déplace tous les membres d'un salon vocal vers un autre" },
      ...
      { name: "bringall [salon]", prefix: "mod", permission: "server.voice.manage", description: "Rassemble tous les membres connectés dans un même salon vocal" },
      { name: "unbanall", prefix: "mod", permission: "moderation.unban", description: "Débannit tout le monde (confirmation obligatoire)" },
