...
const CATEGORIES = [
  ...
  },
  {
    ...
    commands: [
      ...
      { name: "tempmute <membre> <durée> [raison]", prefix: "mod", permission: "moderation.timeout", description: "Rend un membre muet temporairement" },
      { name: "unmute <membre>", prefix: "mod", permission: "moderation.timeout", description: "Lève le mute d'un membre" },
      { name: "cmute <membre> [raison]", prefix: "mod", permission: "moderation.timeout", description: "Alias de `mute` (même rôle, pas de distinction chat/vocal)" },
      { name: "tempcmute <membre> <durée> [raison]", prefix: "mod", permission: "moderation.timeout", description: "Alias de `tempmute`" },
      { name: "uncmute <membre>", prefix: "mod", permission: "moderation.timeout", description: "Alias de `unmute`" },
