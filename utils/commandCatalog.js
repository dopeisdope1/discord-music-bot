  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        prefix: "mod",
        permission: "server.tickets.manage",
        description: "Prend en charge le ticket courant — ne fait rien en dehors d'un ticket ouvert",
      },
      {
        name: "rename <nom>",
        prefix: "mod",
        permission: "server.tickets.manage",
        description: "Renomme le ticket courant — ne fait rien en dehors d'un ticket ouvert",
      },
      {
        name: "add <membre>",
        prefix: "mod",
        permission: "server.tickets.manage",
        description: "Ajoute un membre au ticket courant — ne fait rien en dehors d'un ticket ouvert",
      },
      {
        name: "remove <membre>",
        prefix: "mod",
        permission: "server.tickets.manage",
        description: "Retire un membre du ticket courant (pas son créateur) — en dehors d'un ticket, retire l'activité du bot (voir aussi &remove activity)",
      },
      {
        name: "close [raison]",
        prefix: "mod",
        permission: "server.tickets.manage",
        description: "Ferme le ticket courant, même droit que le bouton \"Fermer\" — ne fait rien en dehors d'un ticket ouvert",
      },
      {
        name: "modmail",
        prefix: "mod",
