...
// partagé avec le CrowBot.
const CATEGORIES = [
  {
    key: "utilitaire",
    label: "Utilitaire",
    commands: [
      { name: "pic [@membre]", prefix: "mod", permission: null, aliases: ["avatar"], description: "Affiche l'avatar d'un membre" },
      { name: "banner [@membre]", prefix: "mod", permission: null, description: "Affiche la bannière d'un membre" },
      { name: "server", prefix: "mod", permission: null, aliases: ["serverinfo"], description: "Affiche les informations du serveur (identifiant, propriétaire, membres, bots, salons, rôles, boosts)" },
      { name: "userinfo [@membre]", prefix: "mod", permission: null, aliases: ["member"], description: "Informations sur un membre (rôles, arrivée, timeout en cours)" },
      ...
      { name: "boosters", prefix: "mod", permission: "server.members.list", description: "Affiche la liste des membres boostant le serveur" },
      { name: "rolemembers <rôle>", prefix: "mod", permission: "server.members.list", description: "Affiche la liste des membres ayant un rôle précis (mention, ID ou nom)" },
      { name: "vocinfo", prefix: "mod", permission: "server.info.view", description: "Affiche les informations relatives à l'activité vocale du serveur" },
      { name: "role <rôle> (infos)", prefix: "mod", permission: "server.info.view", description: "Affiche les informations relatives à un rôle" },
      { name: "channel [salon] (infos)", prefix: "mod", permission: "server.info.view", description: "Affiche les informations relatives à un salon" },
      { name: "user [membre]", prefix: "mod", permission: "server.info.view", description: "Affiche les informations d'un compte Discord, même s'il n'est pas sur le serveur" },
      ...
      { name: "emoji <émoji>", prefix: "mod", permission: "server.info.view", description: "Récupère l'image d'un émoji personnalisé (émoji, nom ou ID), y compris venu d'un autre serveur" },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: "lockdown", prefix: "mod", permission: "channels.lockdown", aliases: ["panic"], description: "Verrouille tous les salons gérables (urgence)" },
      ...
      { name: "sanctions <membre>", prefix: "mod", permission: "logs.view", description: "Affiche les sanctions d'un membre" },
      ...
      { name: "tempmute <membre> <durée> [raison]", prefix: "mod", permission: "moderation.timeout", aliases: ["tempcmute"], description: "Rend un membre muet temporairement" },
      { name: "unmute <membre>", prefix: "mod", permission: "moderation.timeout", aliases: ["uncmute"], description: "Lève le mute d'un membre" },
      { name: "mutelist", prefix: "mod", permission: "moderation.timeout", description: "Affiche la liste des membres actuellement mute" },
      { name: "unmuteall", prefix: "mod", permission: "moderation.unmuteall", description: "Lève le mute de tous les membres mute" },
      { name: "tempban <membre> <durée> [raison]", prefix: "mod", permission: "moderation.ban", description: "Bannit un membre temporairement, débanni automatiquement à l'échéance" },
      { name: "banlist", prefix: "mod", permission: "moderation.unban", description: "Affiche la liste des membres bannis" },
      { name: "hideall", prefix: "mod", permission: "channels.manageall", description: "Masque tous les salons gérables à @everyone" },
      { name: "unhideall", prefix: "mod", permission: "channels.manageall", description: "Réaffiche tous les salons masqués" },
      { name: "derank <membre>", prefix: "mod", permission: "members.role", description: "Retire tous les rôles d'un membre" },
    ],
  },
  {
    key: "server",
    ...
    commands: [
      ...
      { name: "voicekick <membre>", prefix: "mod", permission: "server.voice.manage", description: "Expulse un membre du salon vocal" },
      { name: "cleanup <salon>", prefix: "mod", permission: "server.channels.manage", description: "Nettoie les messages orphelins/indésirables d'un salon" },
      { name: "bringall [salon]", prefix: "mod", permission: "server.voice.moveall", description: "Rassemble tous les membres connectés dans un même salon vocal" },
      { name: "unbanall", prefix: "mod", permission: "moderation.unbanall", description: "Débannit tout le monde (confirmation obligatoire)" },
      { name: "temprole <membre> <rôle> <durée>", prefix: "mod", permission: "members.role", description: "Donne un rôle temporaire à un membre" },
      { name: "untemprole <membre> <rôle>", prefix: "mod", permission: "members.role", description: "Retire un rôle temporaire avant son échéance" },
      { name: "sync <salon/catégorie/all>", prefix: "mod", permission: "server.channels.manage", description: "Resynchronise les permissions d'un salon avec sa catégorie" },
      { name: "openmodmail <membre>", prefix: "mod", permission: "server.tickets.manage", description: "Ouvre un modmail avec un membre" },
      { name: "button <add/del> <lien>", prefix: "mod", permission: null, description: "Ajoute/retire un bouton de lien sur le prochain message" },
      { name: "autoreact <add/del> <salon> <émoji>", prefix: "mod", permission: "server.channels.manage", description: "Ajoute/retire une réaction automatique sur les nouveaux messages d'un salon" },
      { name: "autoreact list", prefix: "mod", permission: "server.channels.manage", description: "Liste les réactions automatiques configurées" },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: "ticket settings", prefix: "mod", permission: "server.tickets.manage", description: "Affiche/configure les réglages des tickets" },
      { name: "claim", prefix: "mod", permission: "server.tickets.manage", description: "Prend en charge le ticket courant" },
      { name: "rename <nom>", prefix: "mod", permission: "server.tickets.manage", description: "Renomme le ticket courant" },
      { name: "add <membre>", prefix: "mod", permission: "server.tickets.manage", description: "Ajoute un membre au ticket courant" },
      { name: "del <membre>", prefix: "mod", permission: "server.tickets.manage", description: "Retire un membre du ticket courant" },
      { name: "close [raison]", prefix: "mod", permission: "server.tickets.manage", description: "Ferme le ticket courant" },
      { name: "tempvoc", prefix: "mod", permission: "server.voice.manage", description: "Affiche la configuration des salons vocaux temporaires (voir aussi &voicehub)" },
      { name: "tempvoc cmd", prefix: "mod", permission: "server.voice.manage", description: "Configure les commandes disponibles pour les salons vocaux temporaires" },
      { name: "twitch", prefix: "mod", permission: "server.channels.manage", description: "Configure les annonces de live Twitch" },
      { name: "join settings", prefix: "mod", permission: "server.welcome.manage", description: "Affiche/configure les réglages d'arrivée (voir aussi la rubrique Bienvenue)" },
      { name: "leave settings", prefix: "mod", permission: "server.welcome.manage", description: "Affiche/configure les réglages de départ" },
      { name: "autorole add @rôle", prefix: "mod", permission: "members.autorole.manage", description: "Ajoute un rôle donné automatiquement à chaque nouvel arrivant" },
      { name: "autorole del @rôle", prefix: "mod", permission: "members.autorole.manage", description: "Retire un rôle automatique" },
      { name: "autorole list", prefix: "mod", permission: "members.autorole.manage", description: "Liste les rôles automatiques configurés" },
      {
      ...
      { name: "custom <mot-clé>", prefix: "mod", permission: "server.channels.manage", description: "Crée une commande personnalisée déclenchée par un mot-clé" },
      { name: "customlist", prefix: "mod", permission: null, description: "Liste les commandes personnalisées du serveur" },
      { name: "clear customs", prefix: "mod", permission: "server.channels.manage", description: "Supprime toutes les commandes personnalisées" },
      { name: "custom transfer <ID/nombre>", prefix: "mod", permission: "server.channels.manage", description: "Transfère une commande personnalisée" },
      { name: "restrict <émoji> <rôle>", prefix: "mod", permission: "server.roles.manage", description: "Restreint l'usage d'un émoji à un rôle" },
      { name: "unrestrict <émoji>", prefix: "mod", permission: "server.roles.manage", description: "Retire la restriction d'un émoji" },
      { name: "soutien", prefix: "mod", permission: null, description: "Affiche les informations de soutien du bot" },
      { name: "set perm <permission/commande> <rôle/membre>", prefix: "mod", permission: "panel.permissions.manage", description: "Accorde une permission à un rôle ou un membre (voir aussi la rubrique Permissions)" },
      { name: "del perm <rôle>", prefix: "mod", permission: "panel.permissions.manage", description: "Retire les permissions accordées à un rôle" },
      { name: "clear perms", prefix: "mod", permission: "panel.permissions.manage", description: "Réinitialise toutes les permissions accordées" },
      { name: "prefix <préfixe>", prefix: "mod", permission: "sys", description: "Change le préfixe des commandes (voir aussi la rubrique Préfixes)" },
      { name: "modmail", prefix: "mod", permission: "server.tickets.manage", description: "Affiche/configure le système de modmail" },
      { name: "report settings", prefix: "mod", permission: "panel.permissions.manage", description: "Configure le système de signalement" },
      { name: "show pics", prefix: "mod", permission: null, description: "Affiche/masque les photos de profil dans certains affichages" },
      { name: "autopublish <on/off>", prefix: "mod", permission: "server.channels.manage", description: "Publie automatiquement les messages dans les salons d'annonces" },
      { name: "suggestion settings", prefix: "mod", permission: "panel.permissions.manage", description: "Configure le système de suggestions" },
    ],
  },
  {
    key: "logs",
    label: "Logs",
    commands: [
      { name: "settings", prefix: "mod", permission: "logs.manage", description: "Affiche un résumé des salons de logs configurés (voir aussi &panel > Logs) ; le résumé de l'anti-spam est dans &panel > Protection" },
      { name: "modlog on [salon]", prefix: "mod", permission: "logs.manage", description: "Active les logs de modération dans un salon" },
      { name: "modlog off", prefix: "mod", permission: "logs.manage", description: "Désactive les logs de modération" },
      { name: "set modlogs", prefix: "mod", permission: "logs.manage", description: "Règle le salon de logs de modération (voir aussi &panel > Logs)" },
      { name: "messagelog on [salon]", prefix: "mod", permission: "logs.manage", description: "Active les logs de messages (édition/suppression) dans un salon" },
      { name: "messagelog off", prefix: "mod", permission: "logs.manage", description: "Désactive les logs de messages" },
      { name: "voicelog on [salon]", prefix: "mod", permission: "logs.manage", description: "Active les logs vocaux dans un salon" },
      { name: "voicelog off", prefix: "mod", permission: "logs.manage", description: "Désactive les logs vocaux" },
      { name: "boostlog on [salon]", prefix: "mod", permission: "logs.manage", description: "Active les logs de boost dans un salon" },
      { name: "boostlog off", prefix: "mod", permission: "logs.manage", description: "Désactive les logs de boost" },
      { name: "rolelog on [salon]", prefix: "mod", permission: "logs.manage", description: "Active les logs de rôles dans un salon" },
      { name: "rolelog off", prefix: "mod", permission: "logs.manage", description: "Désactive les logs de rôles" },
      { name: "memberlog on|off [salon]", prefix: "mod", permission: "logs.manage", description: "Logs des arrivées/départs et changements de membre" },
      ...
      { name: "boostembed test", prefix: "mod", permission: "logs.manage", description: "Envoie un aperçu de l'embed de boost" },
      { name: "nolog <add/del> [salon]", prefix: "mod", permission: "logs.manage", description: "Exempte (ou non) un salon des logs de messages" },
    ],
  },
  {
    key: "modsettings",
    ...
    commands: [
      ...
      { name: "timeout <on/off>", prefix: "mod", permission: "protection.automod", description: "Active/désactive l'usage du timeout Discord comme sanction" },
      { name: "clear limit <nombre>", prefix: "mod", permission: "protection.automod", description: "Règle le nombre maximum de messages supprimables en une fois" },
      { name: "muterole", prefix: "mod", permission: "protection.automod", description: "Affiche le rôle de mute configuré" },
      { name: "set muterole <rôle>", prefix: "mod", permission: "protection.automod", description: "Configure le rôle utilisé par &mute/&tempmute" },
      { name: "antispam <on/off>", prefix: "mod", permission: "protection.automod", description: "Active/désactive l'anti-spam (voir aussi &panel > Protection)" },
      { name: "antispam <nombre>/<durée>", prefix: "mod", permission: "protection.automod", description: "Règle le seuil de déclenchement de l'anti-spam" },
      { name: "spam <allow/deny/reset> [salon]", prefix: "mod", permission: "protection.automod", description: "Exempte (ou non) un salon de l'anti-spam" },
      { name: "strikes", prefix: "mod", permission: "protection.automod", description: "Affiche le système de sanctions progressives (strikes)" },
      { name: "ancien <durée>", prefix: "mod", permission: "protection.automod", description: "Règle la durée avant qu'un strike soit considéré comme ancien" },
      { name: "strikes <déclencheur> <nombre> [ancien/nouveau]", prefix: "mod", permission: "protection.automod", description: "Configure le nombre de strikes déclenchant une sanction" },
      { name: "punish", prefix: "mod", permission: "protection.automod", description: "Affiche les paliers de sanction automatique configurés" },
      { name: "punish add <nombre> <durée> <sanction> [durée]", prefix: "mod", permission: "protection.automod", description: "Ajoute un palier de sanction automatique" },
      { name: "punish del <nombre>", prefix: "mod", permission: "protection.automod", description: "Retire un palier de sanction automatique" },
      { name: "punish setup", prefix: "mod", permission: "protection.automod", description: "Assistant de configuration des paliers de sanction" },
      { name: "noderank <add/del> <rôle>", prefix: "mod", permission: "protection.automod", description: "Exempte un rôle du &derank automatique" },
      { name: "piconly <add/del> [salon]", prefix: "mod", permission: "protection.automod", description: "Restreint un salon aux messages contenant une image" },
      { name: "public <on/off>", prefix: "mod", permission: "protection.automod", description: "Active/désactive le mode public d'un réglage" },
      { name: "public <allow/deny/reset> [salon]", prefix: "mod", permission: "protection.automod", description: "Exempte (ou non) un salon du mode public" },
    ],
  },
  {
    key: "botcontrol",
    ...
    commands: [
      ...
      { name: "set profil", prefix: "mod", permission: "sys", description: "Permet de modifier d'un coup le profil du bot" },
      {
      ...
      { name: "mp settings", prefix: "mod", permission: "sys", description: "Permet de gérer les messages privés envoyés par le bot" },
      { name: "server list", prefix: "mod", permission: "sys", description: "Affiche la liste des serveurs où se trouve le bot" },
      { name: "invite <ID/nombre>", prefix: "mod", permission: "sys", description: "Envoie une invitation pour un serveur où se trouve le bot" },
      { name: "leave [ID/nombre]", prefix: "mod", permission: "sys", description: "Fait quitter un serveur au bot" },
      { name: "discussion <ID/nombre>", prefix: "mod", permission: "sys", description: "Permet de discuter à travers le bot sur un serveur où il se trouve" },
      ...
      { name: "owner <@membre/ID>", prefix: "mod", permission: "sys", description: "Donne le grade Owner à quelqu'un sur le bot, il aura toutes les permissions dessus" },
      ...
      { name: "bl <@membre/ID> [raison]", prefix: "mod", permission: "sys", description: "Ajoute quelqu'un à la blacklist, il sera banni de tous les serveurs où le bot se trouve" },
      { name: "bl (liste)", prefix: "mod", permission: "sys", description: "Affiche la blacklist du bot" },
      { name: "unbl <@membre/ID>", prefix: "mod", permission: "sys", description: "Retire quelqu'un de la blacklist du bot" },
      { name: "blinfo <@membre/ID>", prefix: "mod", permission: "sys", description: "Affiche toutes les informations concernant la blacklist d'un membre" },
      { name: "clear bl", prefix: "mod", permission: "sys", description: "Supprime tous les membres de la blacklist du bot" },
      { name: "say <message>", prefix: "mod", permission: "sys", description: "Fait dire au bot le message voulu" },
      { name: "change <commande> <permission>", prefix: "mod", permission: "sys", description: "Change la permission nécessaire pour utiliser une commande" },
      { name: "changeall <permission> <permission>", prefix: "mod", permission: "sys", description: "Transfère toutes les commandes d'une permission vers une autre" },
      { name: "change reset", prefix: "mod", permission: "sys", description: "Réinitialise les permissions pour toutes les commandes" },
      { name: "mainprefix <préfixe>", prefix: "mod", permission: "sys", description: "Change le préfixe par défaut du bot" },
      { name: "secur invite <on/off>", prefix: "mod", permission: "sys", description: "Le bot quitte automatiquement quand il rejoint un serveur sans le propriétaire" },
      { name: "helptype <button/select/hybrid>", prefix: "mod", permission: "sys", description: "Change le mode de navigation du menu help entre boutons, sélecteur ou les deux" },
      { name: "alias <commande>", prefix: "mod", permission: "sys", description: "Permet de créer des alias pour les commandes" },
      { name: "helpalias <on/off>", prefix: "mod", permission: "sys", description: "Active/désactive l'utilisation des alias dans les messages de help" },
      { name: "set lang <langue>", prefix: "mod", permission: "sys", description: "Change la langue du bot" },
      { name: "lang custom [on/off/fichier]", prefix: "mod", permission: "sys", description: "Permet de modifier le fichier de langue du bot" },
      { name: "get lang", prefix: "mod", permission: "sys", description: "Affiche les fichiers de configuration de langue actuels" },
      { name: "updatebot", prefix: "mod", permission: "sys", description: "Installe les dernières mises à jour disponibles sur le bot" },
      { name: "autoupdate <on/off>", prefix: "mod", permission: "sys", description: "Active/désactive l'autoupdate" },
      { name: "reset server", prefix: "mod", permission: "sys", description: "Réinitialise tous les paramètres du bot sur un serveur" },
