...
const CATEGORIES = [
  {
    ...
    commands: [
      ...
      { name: "rolemembers <rôle>", prefix: "mod", permission: null, description: "Affiche la liste des membres ayant un rôle précis" },
      ...
      { name: "user [membre]", prefix: "mod", permission: null, description: "Affiche les informations relatives à un utilisateur" },
      { name: "member [membre]", prefix: "mod", permission: null, description: "Affiche les informations relatives à un membre sur le serveur" },
      ...
      { name: "emoji <émoji>", prefix: "mod", permission: null, description: "Permet de récupérer l'image d'un émoji" },
      ...
      { name: "wiki <mot-clé>", prefix: "mod", permission: null, description: "Fait une recherche wikipedia avec le bot" },
      ...
      { name: "calc <calcul>", prefix: "mod", permission: null, description: "Permet de résoudre des calculs ou des équations" },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: "lockdown", prefix: "mod", permission: "channels.lockdown", description: "Verrouille tous les salons gérables (urgence). Alias : `panic`, `lockall`" },
      { name: "unlockdown", prefix: "mod", permission: "channels.lockdown", description: "Lève un lockdown. Alias : `unlockall`" },
      ...
      { name: "warn <membre> [raison]", prefix: "mod", permission: null, description: "Avertit un membre" },
      { name: "mute <membre> [raison]", prefix: "mod", permission: null, description: "Rend un membre muet (rôle dédié, distinct du timeout Discord)" },
      { name: "tempmute <membre> <durée> [raison]", prefix: "mod", permission: null, description: "Rend un membre muet temporairement" },
      { name: "unmute <membre>", prefix: "mod", permission: null, description: "Lève le mute d'un membre" },
      { name: "cmute <membre> [raison]", prefix: "mod", permission: null, description: "Rend un membre muet dans le chat uniquement" },
      { name: "tempcmute <membre> <durée> [raison]", prefix: "mod", permission: null, description: "Rend un membre muet dans le chat temporairement" },
      { name: "uncmute <membre>", prefix: "mod", permission: null, description: "Lève le mute chat d'un membre" },
      { name: "mutelist", prefix: "mod", permission: null, description: "Affiche la liste des membres actuellement mute" },
      { name: "unmuteall", prefix: "mod", permission: null, description: "Lève le mute de tous les membres mute" },
  ...
  },
  {
    ...
    label: "Logs",
    commands: [
      { name: "settings", prefix: "mod", permission: "logs.manage", description: "Affiche un résumé des salons de logs configurés (voir aussi &panel > Logs)" },
  ...
  },
  {
    ...
    commands: [
      ...
      { name: "settings", prefix: "mod", permission: "protection.automod", description: "Affiche un résumé des paramètres de modération" },
