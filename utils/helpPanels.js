...
function assignableCommandLine(prefix, cmd) {
  const lines = {
    ...
    addrole: `\`${prefix}addrole [@membre] [@role]\` — Ajoute un rôle à un membre (menus déroulants pour ce qui manque)`,
    delrole: `\`${prefix}delrole [@membre] [@role]\` — Retire un rôle à un membre (menus déroulants pour ce qui manque)`,
