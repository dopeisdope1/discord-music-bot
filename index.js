...
client.on("interactionCreate", async (interaction) => {
  ...
  // Menus contextuels (clic droit sur un membre > Applications) — voir
  // utils/contextMenus.js. Passent par le même moteur de permissions que les
  // commandes texte (&panel > Permissions).
